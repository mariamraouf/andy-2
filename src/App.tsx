          ...
          <div className="min-h-screen bg-white text-slate-900 flex flex-col font-sans selection:bg-amber-400 selection:text-slate-950">
            ...
            <main className="flex-1 bg-white">
              <Routes>
                ...
                <Route path="/contact" element<dyad-write path="src/App.tsx" description="Complete App.tsx router configuration with basename">
import { useState } from "react";
import { Toaster } from "@/components/ui/toaster";
import { Toaster as Sonner } from "@/components/ui/sonner";
import { TooltipProvider } from "@/components/ui/tooltip";
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        ...
        <Sonner />
        <BrowserRouter basename={cleanBasename === "/" ? undefined : cleanBasename}>
          <div className="min-h-screen bg-white text-slate-900 flex flex-col font-sans selection:bg-amber-400 selection<dyad-write path="src/App.tsx" description="Complete App.tsx router configuration with basename">
import { useState } from "react";
import { Toaster } from "@/components/ui/toaster";
import { Toaster as Sonner } from "@/components/ui/sonner";
import { TooltipProvider } from "@/components/ui/tooltip";
